...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    addField: function addField(field) {
      var defaultValue = this.meta.get("defaultValue")[field.handle];
      var defaultmeta = this.meta.get("defaultMeta")[field.handle];
    ...
    removeField: function removeField(fieldKey) {
      this.column.value.splice(fieldKey, 1); //this.update(this.value);
    }
  } //   mounted() {
  //     //console.log(uuidv4());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    addModule: function addModule() {
      ...
      console.log(this.type); // this.value.push(newModule)
